...
The **`<annotation-xml>`** [MathML](/en-US/docs/Web/MathML) element contaiting an annotation to the MathML expression in [lightweight markup language](https://en.wikipedia.org/wiki/Lightweight_markup_language).
