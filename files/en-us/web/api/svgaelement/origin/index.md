...
The **`origin`** read-only property of the {{domxref("SVGAElement")}} interface returns a string containing the Unicode serialization of the origin of the SVG {{SVGElement("a")}} element's {{SVGAttr("href")}}.
